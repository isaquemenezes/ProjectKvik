    <nav id="mainnavbar" class="navbar navbar-expand-sm navbar-dark bg-dark navtransparente">
            ...
            <?php
                if(isset($_SESSION['id'])){ 
                    ...
                    echo "<a class='navbar-brand' href=".DIRPAGE."index>".
        ...
        <div class="collapse navbar-collapse" id="usernavbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item ml-auto">
                    ...
                    <font style="vertical-align: inherit;">FAQ</font></font></a>
                </li>

                 <!-- SOBRE -->
                <li class="nav-item ml-auto">
                    <a class="nav-link" href="#sobre"><font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">SOBRE</font></font></a>
                </li>
