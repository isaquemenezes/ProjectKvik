...
<form name="formLogin" id="formLogin" action="<?php echo DIRPAGE.'controllers/controllerLogin'; ?>" method="post">
    <div class="login">
        <div class="loginLogomarca float w100 center">
            <img src="<?php echo DIRPAGE.'assets/images/logo_kvik.png'; ?>" alt="Logomarca da Kvik">
        </div>
        ...
        <div class="loginFormulario float w100">
            ...
            <div class="loginTextos float">
            Não tem conta?
            <a href="<?php echo DIRPAGE.'cadastro'; ?>">Nova Conta</a></div>
        </div>
    </div>
</form>
