<?php \Classes\ClassLayout::setHead('Perguntas Frequentes' , 'kvik | Plataforma de Voluntariado');?>
            
<style>
	

	#mainnavbar {
		<!-- background-image: url(/assets/img-general/nav-corporate.jpg); -->
	}
	...
	@media (min-width: 576px) {.section-grey { padding-top: 120px; padding-bottom: 20px;}
		.section-white { padding-top: 100px; padding-bottom: 0px;}}
	@media (min-width: 768px) { .section-grey { padding-top: 120px; padding-bottom: 20px;}
		.section-white { padding-top: 100px; padding-bottom: 0px;}}
	@media (min-width: 992px) {.section-grey {padding-top: 140px;padding-bottom: 20px;}
		.section-white {padding-top: 120px;padding-bottom: 0px;}}
	@media (min-width: 1200px) {.section-grey {padding-top: 180px;padding-bottom: 20px;}
		.section-white {padding-top: 160px;	padding-bottom: 0px;}}

	header, #mainnavbar.fixed-top, #footer, body#login {background-image: url(/assets/img-general/banner-corporate.jpg);}
...
<style>
    ...
    <footer id="footer" class="ptb-xs-40 footer pt-5 pb-5">
		<div class="container">
			<div class="row pb-5" style="text-align:center;">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 button-sw-block">
					<a class="col" target="_blank" href="https://www.facebook.com/plataformakvik/">
                       <i class="fab fa-facebook-f" style="font-size:22px">Obtenha Ajuda Rápida Para Suas Dúvidas</i></a>
			...
			<main class="col p-0 h-100">					
                ...
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            ...
                            <h3>Saúde</h3><img src="./assets/images/"></a><br>
                            Seja uma companhia agradável aos finais de semana, ou ajude com as compras do supermercado.
                                Incentivar a interação, através de jogos que aumentam a concentração e memória.
                                Uma simples companhia de verdade pode mudar tudo! </p>		
                        </div>	
                        
                        <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            <p class="text-center"><a href="">
                            <h3>Mobilidade</h3><img src="./assets/images/"></a><br>
                            Seja uma companhia agradável aos finais de semana, ou ajude com as compras do supermercado.
                                Incentivar a interação, através de jogos que aumentam a concentração e memória.
                                Uma simples companhia de verdade pode mudar tudo!</p>		
                        </div>	
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            <p class="text-center"><a href="">
                            <h3>Combate ao Sedentarismo - Esporte -</h3><img src="./assets/images/"></a><br>
                            Seja uma companhia agradável aos finais de semana, ou ajude com as compras do supermercado.
                                Incentivar a interação, através de jogos que aumentam a concentração e memória.
                                Uma simples companhia de verdade pode mudar tudo!</p>		
                        </div>		
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            ...
                            <h3>Educação Financeira</h3><img src="./assets/images/financeira.png"></a><br>
                                Vamos ajudar nossos idosos a organizarem sua vida financeira. 
                                Isso os tornar mais dono dos seus recursos financeiros e 
                                consequentemente aumenta sua auto confiança.</p>		
                        </div>	
                      	
                        <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            <p class="text-center"><a href="<?php echo DIRPAGE.'./combate-ao-isolamento'; ?>">
                            <h3>Combate ao Isolamento!</h3>
                            <img src="./assets/images/combate_isolamento.png"></a><br> 
                                Seja uma companhia agradável aos finais de semana, ou ajude com as compras do supermercado.
                                Incentivar a interação, através de jogos que aumentam a concentração e memória.
                                Uma simples companhia de verdade pode mudar tudo!</p>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12 py-5 text-center">
                            ...
                            <img src="./assets/images/tecnologia.png"></a><br>
                            Ensine sobre configurções no smarphone, table, ipad, computador, notebook,
                            ou mesmo como manusear o controle da televisão. Ensine coisas básicas sobre informática, 
                            computadores ou tecnologia! </p>
                        </div>					
                        </div>
                        <p class="text-center"><a class="call-to-click" href="#">Junte-se a nós. E mova uma vida </a></p>
                </div>
            </section>
