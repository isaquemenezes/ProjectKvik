	...
	<?php include 'includes/header.php'; ?>
 	...
 	<div class="container-fluid">
		...
		<main class="col p-0 h-100">
			...
			<div class="container">
					<h2 class="cty-h2">Combate Ao Isolamento - Lista </h2>
					...
					<ul>
							...
							<li><div class="card-body">
								<img  src="./assets/images/idososentado.jpg"> Baroudi SALLOUTE<p class="card-text">Book your future premium
								account, and be sure to get one of first premium accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img  src="./assets/images/imagem-login-fundo.jpg">Yassine DJOUMI<p class="card-text">Book your future premium
								account, and be sure to get one of first premium accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded" src="./assets/images/idososentado.jpg"> Amandine GUIOT<p class="card-text">Book your future premium 
								account, and be sure to get one of first premium accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg">Abbas HOJATI<p class="card-text">Book your future premium 
								account, and be sure to get one of first premium accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg">Ewa MACH<p class="card-text">Book your future premium 
								account, and be sure to get one of first premium accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg">Arpine MISAKYAN
								<p class="card-text">Book your future premium account, and be sure to get one of first premium
								accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg">Maria SEMEDO MORENO
								<p class="card-text">Book your future premium account, and be sure to get one of first premium
								accounts at the lauching.<br><br></p>
							</div></li>
							...
							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg"> Romain THERRAT
								<p class="card-text">Book your future premium account, and be sure to get one of first premium 
								accounts at the lauching.<br><br></p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg"> Antoine TRUONG?
								<p class="card-text">Pre-order your future premium account, fitted at your needs and be sure to 
								be an early adopter with 40% bonus credited on your account.</p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg"> Maria Abernais?
								<p class="card-text">Pre-order your future premium account, fitted at your needs and be sure to 
								be an early adopter with 40% bonus credited on your account.</p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg"> Sara Lucia?
								<p class="card-text">Pre-order your future premium account, fitted at your needs and be sure to
								be an early adopter with 40% bonus credited on your account.</p>
							</div></li>

							<li><div class="card-body">
								<img class="rounded-circle" src="./assets/images/imagem-login-fundo.jpg"> Marcos Antonio?
								<p class="card-text">Pre-order your future premium account, fitted at your needs and be sure to
								be an early adopter with 40% bonus credited on your account.</p>
							</div></li>
					</ul>	 
								...
								<div class="container">
									...
									<!--<div class="col-sm-12 col-md-12 col-lg-6 py-5">
										<div class="row">
											...
											<div class="col-9 pt-4">
												...
												Em 2030, Brasil terá a quinta população mais idosa do mundo.</font></font></h4>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 py-5">
										<div class="row">
											...
											<div class="col-9 pt-4">
												<h4 class="cty-h4 pr-lg-5"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">71% dos municípios não têm instituições para idosos</font></font></h4>
												<p class="text-justify pr-lg-5"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
